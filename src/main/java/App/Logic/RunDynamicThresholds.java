...
public class RunDynamicThresholds {
    ...
    public void run(String parametersFileName) throws Exception {
        ...
        int dynamicThreshold = 10;

        while (dynamicThreshold < 200){
            searchModule = new SearchModule(index, similarity, 1, dynamicThreshold);
            ...
            if (truthFilePath != null) {
                ...
                LogHandler.info("For threshold=" + dynamicThreshold + " AvergeF=" + measurement.GetAverageF());
            }
